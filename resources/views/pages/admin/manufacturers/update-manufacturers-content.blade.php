        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            ...
            <div class="manufacturers-img-content">
              ...
              <div class="manufacturers-img" {!! $manufacturers_logo_control['manufacturers_logo'] !!}><img class="img-responsive" src="{{ get_image_url($manufacturers_update_data->logo_url) }}" alt=""></div>
              <br>
