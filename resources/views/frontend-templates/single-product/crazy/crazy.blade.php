      ...
      <div class="col-xs-12 col-sm-5 col-md-5">
        <div class="product-main-content">
          <div class="product-main-image">
            @if( !empty($single_product_details['_product_related_images_url']->product_image) && basename($single_product_details['_product_related_images_url']->product_image) != 'no-image.png')
          ...
          <div id="product_gallery_image" class="product-gallery-image">
            @foreach($single_product_details['_product_related_images_url']->product_gallery_images as $key => $row)
              ...
              @if($count == 1)
              <a  href="#" class="elevatezoom-gallery active" data-image="{{ get_image_url($row->url) }}" data-zoom-image="{{ get_image_url($row->zoom_img_url) }}"><img src="{{ get_image_url($row->url) }}" width="100"  /></a>
              @else
              <a  href="#" class="elevatezoom-gallery" data-image="{{ get_image_url($row->url) }}" data-zoom-image="{{ get_image_url($row->zoom_img_url) }}"><img src="{{ get_image_url($row->url) }}" width="100"  /></a>
              @endif
