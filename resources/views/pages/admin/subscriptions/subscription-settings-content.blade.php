@section('subscription-settings-content')
      ...
      <div class="box box-solid"> 
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              @if(count($subscription_settings_data['popup_display_page']) >0 && in_array('home', $subscription_settings_data['popup_display_page']))  
              ...
              @if(count($subscription_settings_data['popup_display_page']) >0 && in_array('shop', $subscription_settings_data['popup_display_page']))  
                <div style="margin-bottom: 10px;">
              ...
              @if(count($subscription_settings_data['popup_display_page']) >0 && in_array('blog', $subscription_settings_data['popup_display_page']))  
                <div style="margin-bottom: 10px;">
              ...
              @if(count($subscription_settings_data['popup_display_page']) >0 && in_array('cart', $subscription_settings_data['popup_display_page']))  
                <div style="margin-bottom: 10px;">
